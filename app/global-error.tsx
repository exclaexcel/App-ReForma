...
export default function GlobalError({
  ...
  return (
    <html lang="pt-BR">
      <body className="bg-zinc-900 text-zinc-100 min-h-dvh flex items-center justify-center p-6">
        <div className="max-w-sm w-full space-y-6 text-center">
          ...
          {isMissingConfig ? (
            <>
              <div>
                <h1 className="text-xl font-bold text-zinc-100">Configuração necessária</h1>
                <p className="text-sm text-zinc-400 mt-2">
                  As variáveis do Supabase não estão configuradas no Vercel.
                </p>
              </div>
              <div className="rounded-xl border border-zinc-700 bg-zinc-800 p-4 text-left space-y-3">
                ...
                <ol className="text-sm text-zinc-300 space-y-2 list-decimal list-inside">
                  ...
                  <li>
                    Adicione{" "}
                    <code className="text-orange-400 text-xs bg-zinc-900 px-1 rounded">
