...
export default function SignupPage() {
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    // Sign in immediately to get an active session before creating the project
  ...
  return (
    <div className="min-h-dvh bg-stone-50 dark:bg-zinc-900 flex flex-col items-center justify-center px-6 py-8">
      <div className="w-full max-w-sm space-y-8">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div className="p-4 rounded-2xl border border-stone-200 dark:border-zinc-700 bg-white dark:bg-zinc-800/50 space-y-4">
