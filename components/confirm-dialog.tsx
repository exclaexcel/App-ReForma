...
export function ConfirmDialog({
  ...
  return (
    <>
      <div className="fixed inset-0 z-40 bg-black/50 dark:bg-black/60" onClick={onCancel} />
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-sm mx-4">
        <div className="rounded-xl bg-stone-50 dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 shadow-2xl">
          <div className="px-6 py-4 border-b border-stone-200 dark:border-zinc-800">
            <h2 className="text-lg font-bold text-stone-900 dark:text-zinc-100">{title}</h2>
